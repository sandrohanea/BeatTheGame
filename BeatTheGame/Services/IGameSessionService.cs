...
namespace BeatTheGame.Services
{
    public interface IGameSessionService
    {
        ...
        Task<GameSession> CreateGameSessionAsync(Player organizer, bool allowRedCards, int cardsInHand, int cardsPerTurn, int numberOfDecks, int numberOfCardsInTheDeck);
